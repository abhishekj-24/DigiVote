...
/**
 * Middleware: Check if election is in registration phase (before deadline)
 */
...
/**
 * Middleware: Check if voting period is active (server time)
 */
...
/**
 * Get current server time and election config (for sync)
 */
